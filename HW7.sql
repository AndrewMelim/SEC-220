...
INSERT INTO Store.orders(product, cost, customerid) VALUES ('football', '10','1');
INSERT INTO Store.orders(product, cost, customerId) VALUES ('helmet', '15','1');
INSERT INTO Store.orders(product, cost, customerId) VALUES ('football', '10','2');
INSERT INTO Store.orders(product, cost, customerId) VALUES ('helmet', '15','2');
INSERT INTO Store.orders(product, cost, customerid) VALUES ('jersey', '25', '1');
INSERT INTO Store.orders(product, cost, customerId) VALUES ('cleats', '10','1');
INSERT INTO Store.orders(product, cost, customerid) VALUES ('jersey', '25', '2');
INSERT INTO Store.orders(product, cost, customerId) VALUES ('cleats', '10','2');
...
DELETE from Store.orders where id = 10;
DELETE from Store.orders where id in (8,9);

SELECT customers.firstname, customers.lastname, orders.customerId
FROM customers
